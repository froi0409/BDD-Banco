 ...
 * @author froi-pc
 */
@WebServlet(name = "TransaccionInicio", urlPatterns = {"/TransaccionInicio"})
public class TransaccionInicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TransaccionInicio</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TransaccionInicio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<String[]> listaDestino = datosCuenta.propietarioPorCuenta(datosCliente.cuentasAsociadas(dpiCliente));
        ArrayList<String> listaOrigen = datosCliente.cuentasPropias(dpiCliente);
        
        
        request.setAttribute("listaCuentasAsociadas", listaDestino);
        request.setAttribute("listaCuentasPropias", listaOrigen);
