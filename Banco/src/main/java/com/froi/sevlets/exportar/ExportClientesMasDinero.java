 ...
 * @author froi-pc
 */
@WebServlet(name = "ExportClientesMasDinero", urlPatterns = {"/ExportClientesMasDinero"})
public class ExportClientesMasDinero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=clientesConMasDinero.pdf");
            ...
            File file = new File(request.getServletContext().getRealPath("/resources/gerente/clientes_mas_dinero.jrxml"));
