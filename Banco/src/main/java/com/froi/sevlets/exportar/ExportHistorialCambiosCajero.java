 ...
 * @author froi-pc
 */
@WebServlet(name = "ExportHistorialCambiosCajero", urlPatterns = {"/ExportHistorialCambiosCajero"})
public class ExportHistorialCambiosCajero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<String[]> historialCambios = historial.cajero();
            ...
            File file = new File(request.getServletContext().getRealPath("/resources/gerente/historial_cambios_cajero.jrxml"));
