...
import com.froi.cliente.reportes.HistorialSolicitudesRecibidas;
 ...
 * @author froi-pc
 */
@WebServlet(name = "ExportSolicitudesRecibidas", urlPatterns = {"/ExportSolicitudesRecibidas"})
public class ExportSolicitudesRecibidas extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=historialSolicitudesRecibidas.pdf");
            ...
            File file = new File(request.getServletContext().getRealPath("/resources/cliente/historial_solicitudes_recibidas.jrxml"));
