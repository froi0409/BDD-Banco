 ...
 * @author froi-pc
 */
@WebServlet(name = "ExportCuentaMasDinero", urlPatterns = {"/ExportCuentaMasDinero"})
public class ExportCuentaMasDinero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=cuentaMasDinero.pdf");
            ...
            ArrayList<String[]> cuentaConMasDinero = (ArrayList) request.getSession().getAttribute("transacciones");


            ConvertToList convertidor = new ConvertToList();
            
            List<ColeccionDatos> lista = convertidor.getArrayList(cuentaConMasDinero);

            for(ColeccionDatos element: lista){
                element.setSextaColumna(codigoCuenta);
            }
            
            File file = new File(request.getServletContext().getRealPath("/resources/cliente/cuenta_mas_dinero.jrxml"));
