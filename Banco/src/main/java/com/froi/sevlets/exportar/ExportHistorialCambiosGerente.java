 ...
 * @author froi-pc
 */
@WebServlet(name = "ExportHistorialCambiosGerente", urlPatterns = {"/ExportHistorialCambiosGerente"})
public class ExportHistorialCambiosGerente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<String[]> historialCambios = historial.gerente();
            ...
            File file = new File(request.getServletContext().getRealPath("/resources/gerente/historial_cambios_gerente.jrxml"));
