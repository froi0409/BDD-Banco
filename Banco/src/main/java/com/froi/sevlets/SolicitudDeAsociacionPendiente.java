...
import com.froi.cliente.SolicitudesPendientes;
 ...
 * @author froi-pc
 */
@WebServlet(name = "SolicitudDeAsociacionPendiente", urlPatterns = {"/SolicitudDeAsociacionPendiente"})
public class SolicitudDeAsociacionPendiente extends HttpServlet {
