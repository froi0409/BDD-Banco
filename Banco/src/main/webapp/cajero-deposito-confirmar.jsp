<%-- 
    Document   : cajero-deposito-confirmar
    Created on : 14/11/2020, 06:04:40
    Author     : froi-pc
--%>
    ...
    <body>
        ...
        <form action="DepositoRealizar" method="POST">
            ...
            <div class="container formulario pt-2"> 
                ...
                <div class="row justify-content-center ml-2 pt- mt-5 mr-1"> <!-- Utilizamos el sistema de filas de bootstrap -->
                    <div class="col-md-6" align="center">
                        <label for="monto"><b>Cantidad a Depósitar (Q):</b></label><br>
                ...
                <div class="row justify-content-center ml-2 pt-1 mt-5 mr-1 mb-4">
                    <div class="col-md-6" align="center"><label>¿Desea continuar con el depósito?</label><br></div>
                </div>
