<%-- 
    Document   : gerente-reporte-cajero-mas-transacciones-datos
    Created on : 15/11/2020, 15:00:21
    Author     : froi-pc
--%>
...
<html>
    ...
    <body>
        ...
        <form action="gerente-reporte-cajero-mas-transacciones.jsp" method="POST">
