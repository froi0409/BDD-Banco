...
function tipoEntrada2(){
    ...
    if(change == "birth") {
        ...
        document.getElementById('contraseña').style.display = 'none';
        document.getElementById('opcion').style.display = 'none';
        document.getElementById('opcionTurno').style.display = 'none';
    ...
    } else if (change == 'turno') {
        
        document.getElementById('texto').style.display = 'none';
        document.getElementById('fecha').style.display = 'none';
        document.getElementById('contraseña').style.display = 'none';
        document.getElementById('opcion').style.display = 'none';
        document.getElementById('opcionTurno').style.display = 'block';
