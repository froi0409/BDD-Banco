<%-- 
    Document   : gerente-reporte-historial-cambios-gerente
    Created on : 16/11/2020, 11:52:22
    Author     : froi-pc
--%>
...
<html>
    ...
    <body>
        ...
        <div align="center" style="padding-top: 100px;">
            <h1>Historial de Cambios de Gerente</h1>
        </div>
        <div class="container-fluid" align="center">
            <form action="ExportHistorialCambiosGerente" method="POST" style="padding-top: 50px;">
        ...
        <div class="container" align="center" style="margin-top: 100px; margin-bottom: 50px;">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    ArrayList<String[]> cambios = reporte.gerente();
